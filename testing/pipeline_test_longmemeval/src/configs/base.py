...
from src.embeddings.configs import EmbedderConfig
from src.llms.configs import LlmConfig
from src.vector_stores.configs import VectorStoreConfig

# Set up the directory path
home_dir = os.path.expanduser("~")
mem0_dir = os.environ.get("HISTORY_DIR") or os.path.join(home_dir, ".history")
