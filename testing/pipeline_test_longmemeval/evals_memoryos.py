...
def process_item(item_data):
    ...
    gt_answer = str(item["original_answer"])
    pred_answer = str(item["system_answer"])
...
def main():
    ...
    parser.add_argument(
        # "--input_file", type=str, default="results/all_lme_oracle_results_qwen_dict.json", help="Path to the input dataset file"
        "--input_file", type=str, default="results/all_lme_oracle_results_llama_dict.json", help="Path to the input dataset file"
    )
    parser.add_argument(
