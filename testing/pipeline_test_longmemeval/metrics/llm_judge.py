...
from src.memory.utils import extract_json
from dotenv import load_dotenv
import os

load_dotenv()

# Respect OPENAI_BASE_URL / OPENAI_JUDGE_MODEL so we can route through the
# local vLLM gpt-oss-120b judge for paper-consistent scoring.
_base_url = os.getenv("OPENAI_BASE_URL") or None
client = OpenAI(api_key=os.getenv("OPENAI_API_KEY", "EMPTY"), base_url=_base_url)
