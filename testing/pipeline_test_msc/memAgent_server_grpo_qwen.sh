...
# memAgent grpo
MODEL_NAME="grpo"
MODEL_PATH="/hkfs/work/workspace/scratch/lmu_xjh4853-mem0rl/grpo-memAgent-multi-evidence-EM-reward-Qwen2.5-7B-Instruct-0913/hf_converted/global_step_14" 
...
nohup python3 -m vllm.entrypoints.openai.api_server \
    ...
    > memAgent_grpo_qwen_server.log 2>&1 &
