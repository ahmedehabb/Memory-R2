...
for i in "${!STAGES[@]}"; do
    ...
    export STAGE_EXP_NAME="curr_${STAGE_SESSIONS}sess_${JOB_ID}_${MAX_NUM_TURNS}turns_${PPO_EPOCHS}ppo_Kl${kl_loss_coef}_${REWARD_TYPE}_${COMPRESSION_PENALTY}addcomp_turn_${algorithm}_${NUM_TRAIN_CONVS}convs${num_rollouts}r_innergrpo${INNER_GPRO_FRAC}sampleQA_pen0oss120b_topkmem${TOP_K_MEMORIES}"
    ...
    PYTHONUNBUFFERED=1 python -m verl.rema_trainer.main_ppo \
        ...
        +actor_rollout_ref.rollout.top_k_memories_for_operations=$TOP_K_MEMORIES \
