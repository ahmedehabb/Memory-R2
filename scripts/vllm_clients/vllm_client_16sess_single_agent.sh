...
# N4 — 16-sess single-agent curriculum continuation.
# Continues from the 8-sess single-agent checkpoint (`8sess_single_agent_turns4_..._step10`).
...
export STAGE_EXP_NAME="16sess_single_agent_n4_turns${MAX_NUM_TURNS}_${PPO_EPOCHS}ppo_Kl${kl_loss_coef}_${REWARD_TYPE}_${COMPRESSION_PENALTY}addcomp_turn_${algorithm}_${NUM_TRAIN_CONVS}convs${num_rollouts}r_innergrpo${INNER_GPRO_FRAC}"
