...
export RUN_TAG=${RUN_TAG:-32sess_comp03_thresh05}
...
export BASE_MODEL=/hkfs/work/workspace/scratch/tum_eyi5958-myspace2/projects/ReMA-public/checkpoints/rema-curriculum-v1/curr_16sess_3938125_4turns_2ppo_Kl0.001_persession_0.2addcomp_turn_grpo_1convs16r_innergrpo0.5sampleQA_pen0oss120b/global_step_5/hf_fixed
...
# we fixed the convs used in each split.
NUM_TRAIN_CONVS=1
NUM_VAL_CONVS=1
NUM_TEST_CONVS=8
algorithm=grpo
...
CLIP_RATIO=0.2
export REMA_REWARD_COMPRESSION_THRESHOLD_FRAC=0.5
...
STAGES=(32)
EPOCHS_PER_STAGE=(5)
QA_TOP_K_PER_STAGE=(50)  # per speaker: 8-sess=30, 16-sess=50, 32-sess=50 (80 overflows judge 16384 ctx: 400 items×~100tok/item)
INNER_GPRO_FRAC=0.5
...
for i in "${!STAGES[@]}"; do
    ...
    export STAGE_EXP_NAME="curr_${STAGE_SESSIONS}sess_${RUN_ID}_${MAX_NUM_TURNS}turns_${PPO_EPOCHS}ppo_Kl${kl_loss_coef}_${REWARD_TYPE}_${COMPRESSION_PENALTY}addcomp_turn_${algorithm}_${NUM_TRAIN_CONVS}convs${num_rollouts}r_innergrpo${INNER_GPRO_FRAC}sampleQA_pen0oss120b_thresh05"
