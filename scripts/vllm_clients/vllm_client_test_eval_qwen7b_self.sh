...
RENDEZVOUS_DIR=${RENDEZVOUS_DIR:-<repo>/vllm_servers_qwen7b_self}
...
export OPENAI_CACHE_DIR=<workspace>/openai_cache_qwen7b_self_1778001260
...
export OPENAI_JUDGE_MODEL="qwen7b-self"
