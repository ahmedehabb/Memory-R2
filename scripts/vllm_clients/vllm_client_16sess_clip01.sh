...
export BASE_MODEL=/hkfs/work/workspace/scratch/tum_eyi5958-myspace2/projects/ReMA-public/checkpoints/rema-curriculum-v1/curr_8sess_3936250_4turns_2ppo_Kl0.001_persession_0.2addcomp_turn_grpo_1convs16r_innergrpo0.5sampleQA_pen0oss120b/global_step_10/hf_fixed
...
STAGES=(16)
EPOCHS_PER_STAGE=(5)
QA_TOP_K_PER_STAGE=(50)  # per speaker: 8-sess=30, 16-sess=50, 32-sess=80
INNER_GPRO_FRAC=0.5
