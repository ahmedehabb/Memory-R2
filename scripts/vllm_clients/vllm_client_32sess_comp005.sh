...
# N7 comp=0.05 32-sess (refines sweep between 0 and 0.1). Fills the missing low-but-not-zero point in the comp sweep.
...
export COMPRESSION_PENALTY=0.05

export STAGES_OVERRIDE=32
export EPOCHS_PER_STAGE_OVERRIDE=5

export RUN_TAG="n7_comp005_32sess"
