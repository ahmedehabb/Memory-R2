...
export CURRENT_MODEL_PATH_OVERRIDE="${CURRENT_MODEL_PATH_OVERRIDE:-/hkfs/work/workspace/scratch/tum_eyi5958-myspace2/projects/ReMA-public/checkpoints/rema-curriculum-v1/curr_8sess_8sess_inner0_j3940568__20260331_075755_4turns_2ppo_Kl0.001_persession_0.2addcomp_turn_grpo_1convs16r_innergrpo0.0sampleQA_pen0oss120b/global_step_10/hf_fixed}"
