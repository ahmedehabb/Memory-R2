...
export RUN_TAG=${RUN_TAG:-32sess_comp03_thresh09}
...
CLIP_RATIO=0.2
export REMA_REWARD_COMPRESSION_THRESHOLD_FRAC=0.9
...
for i in "${!STAGES[@]}"; do
    ...
    export STAGE_EXP_NAME="curr_${STAGE_SESSIONS}sess_${RUN_ID}_${MAX_NUM_TURNS}turns_${PPO_EPOCHS}ppo_Kl${kl_loss_coef}_${REWARD_TYPE}_${COMPRESSION_PENALTY}addcomp_turn_${algorithm}_${NUM_TRAIN_CONVS}convs${num_rollouts}r_innergrpo${INNER_GPRO_FRAC}sampleQA_pen0oss120b_thresh09"
