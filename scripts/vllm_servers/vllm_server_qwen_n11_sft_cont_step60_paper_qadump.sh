#!/bin/bash
# Paper-eval judge server: SFT-RL cont step60.
...
VLLM_JUDGE_MODEL="${VLLM_JUDGE_MODEL:-/hkfs/work/workspace/scratch/tum_eyi5958-myspace2/projects/ReMA-public/outputs/answer_agent_sft_hf/n11_sft_cont_step60_20260426_221357}"
...
RENDEZVOUS_DIR=/hkfs/work/workspace/scratch/tum_eyi5958-myspace2/projects/ReMA-public/vllm_servers_qwen_n11_sft_cont_step60_paper_qadump
mkdir -p "$RENDEZVOUS_DIR"

SERVER_IDX=${SERVER_IDX:-0}
VLLM_PORT=${VLLM_PORT:-$((8160 + SERVER_IDX))}
...
LOG_DIR=/hkfs/work/workspace/scratch/tum_eyi5958-myspace2/projects/ReMA-public/logs/vllm_server_qwen_step60_paper
...
echo "[step60-judge $SERVER_IDX] Rendezvous written: $(hostname):${VLLM_PORT}"
echo "[step60-judge $SERVER_IDX] Starting vLLM server for $VLLM_JUDGE_MODEL ..."
