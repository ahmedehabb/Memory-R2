...
MEM_DIR="${RESULTS_DIR}/longmemeval_s_cleaned_${TIER}_memory"
DATASET="${PIPE_DIR}/dataset/longmemeval_s_cleaned.json"
ADD_LOG="${RESULTS_DIR}/longmemeval_s_cleaned_${TIER}_add_parallel_$(date +%Y%m%d_%H%M%S).log"
