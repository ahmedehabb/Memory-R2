...
#   srun --jobid=<training_job_id> bash vllm_client_standalone.sh
...
mkdir -p $LOG_DIR $TMPDIR $RAY_TMPDIR $HYDRA_RUN_DIR $SCRATCH_DIR \
         ...
         $OPENAI_CACHE_DIR $TEACHER_CACHE_DIR $DATASET_DIR
...
export BASE_MODEL=/hkfs/work/workspace/scratch/tum_eyi5958-myspace2/projects/ReMA-public/checkpoints/rema-curriculum-v1/curr_16sess_3933784_4turns_2ppo_Kl0.003_persession_0.2addcomp_turn_grpo_1convs8r_innergrpo0.25sampleQA_pen0oss120b/global_step_10/hf_fixed
