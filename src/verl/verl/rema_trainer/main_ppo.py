...
"""
from verl.rema_trainer.ppo.ray_trainer import RayReMATrainer
...
class TaskRunner:
    ...
    def run(self, config):
        ...
        from verl.rema_trainer.ppo.ray_trainer import ResourcePoolManager, Role
        ...
        trainer = RayReMATrainer(config=config,
                                tokenizer=tokenizer,
                                processor=processor,
